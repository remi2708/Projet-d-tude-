...
const AdminView = ({ zones, setCurrentPage, currentUser }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 px-4 py-6 sm:px-8 pb-20 animate-fadeIn overflow-x-hidden">
      <div className="mx-auto max-w-[1400px] space-y-6">
        <header className="rounded-[2rem] bg-gradient-to-r from-emerald-700 to-slate-900 text-white px-4 py-6 sm:p-8 shadow-xl">
          <div className="flex flex-col items-center gap-4">
            <div className="w-full min-w-0 text-center">
              ...
              <h1 className="mt-4 text-3xl sm:text-4xl font-bold break-words text-center">Espace administration</h1>
              <p className="mt-2 text-sm text-white/80 break-words w-full">Gestion centralisée des utilisateurs, des synchronisations de données, des modèles IA et des statistiques d’usage.</p>
            </div>
            <div className="w-full rounded-[2rem] bg-white/10 p-4 text-center min-w-0">
              ...
              <p className="text-sm text-white/70 break-words">{currentUser.email}</p>
            </div>
          </div>
        </header>
              ...
              <section className="rounded-[2rem] bg-white p-6 shadow-sm border border-slate-200 min-w-0">
                <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-stretch">
                    <div className="rounded-3xl bg-slate-50 p-4 flex flex-col items-center justify-center min-h-[88px]">
                          ...
                          <div key={user.uid} className="px-4 py-4">
                            <div className="rounded-2xl bg-white p-4 shadow-sm border border-slate-200">
                              ...
                              <div className="mt-3 grid grid-cols-2 gap-2">
                                <button onClick={() => removeUser(user.uid)} className="w-full rounded-3xl bg-red-100 px-3 py-2 text-xs font-bold text-red-700">Supprimer</button>
                                <button onClick={() => setSelectedUser(user)} className="w-full rounded-3xl bg-slate-100 px-3 py-2 text-xs font-semibold text-slate-700">Voir</button>
                              </div>
                            </div>
                          </div>
                        ))}
